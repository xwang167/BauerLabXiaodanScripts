...
elseif strcmp(systemType,'EastOIS1+laser')
    ...
    info.gbox = 5;
    info.gsigma = 1.2;
    info.Contrasts={'HbO','HbR','HbT','Laser'};%xw 20220601 add laser
    info.colors = {'r','b','k','c'};
...
elseif strcmp(systemType,'EastOIS1_FAD')
    ...
    info.LEDFiles = {'M470nm_SPF_pol.txt', ...
        ...
        'East3410OIS1_TL_625_Pol.txt'};
    info.fluorFiles = {};
    info.FADFiles = {'fad_emission.txt'};%%xw 051322 from info. fluorFile to info. FADFiles
    info.chHb = 2:4;
    info.chFluor = []; %% xw 051322 from 1 to [];
    info.chFAD = 1;%% xw 051322 from [] to 1;
    info.chSpeckle = [];
    info.chLaser = [];
    info.numInvalidFrames = 1;
    info.validThr = [1 16382];
...
elseif strcmp(systemType,'EastOIS2+laser')
    ...
    info.gbox = 5;
    info.gsigma = 1.2;
    info.Contrasts={'HbO','HbR','HbT','Calcium','Laser'};%xw 20220601 add laser
