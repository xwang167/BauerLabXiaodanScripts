function [T,W,A,r,r2,hemoPred] = interSpeciesGammaFit_mask(neural,hemo,t)
...
mask = logical(leftMask_small + rightMask_small);
...
for xInd = 1:size(neural,2)
    for yInd = 1:size(neural,1)
        ...
        if sum(pixHemo.^2) > 0
            ...
            [~,pixHrfParam] = evalc('fminsearchbnd(fcn,[2,3,0.0001])');
