...
for excelRow = excelRows
    ...
    elseif strcmp(sessionInfo.mouseType,'jrgeco1a-opto3')
        ...
        load(fileName_cam2)
        if strcmp(sessionInfo.mouseType,'jrgeco1a')||strcmp(sessionInfo.mouseType,'jrgeco1a-opto2')
        ...
        if ~exist(fullfile(saveDir,processedName))
            ...
            if strcmp(char(sessionInfo.mouseType),'gcamp6f')||strcmp(char(sessionInfo.mouseType),'jrgeco1a')||strcmp(char(sessionInfo.mouseType),'jrgeco1a-opto3')||strcmp(char(sessionInfo.mouseType),'Gopto3')||strcmp(char(sessionInfo.mouseType),'Wopto3')
                ...
                if ~isFluorGot
                    ...
                    baseline_Fluor = mean(xform_fluor(:,:,sessionInfo.stimbaseline+1:end),3);
                    
                    xform_Reflectance = squeeze(xform_raw(:,:,sessionInfo.refChan,:));
                    baseline_Reflectance = mean(xform_Reflectance(:,:,sessionInfo.stimbaseline+1:end),3);
                    if strcmp(sessionInfo.mouseType,'jrgeco1a-opto3')
                        xform_Laser = squeeze(xform_raw(:,:,sessionInfo.peakChan,:));
                    end
         
                    xform_fluor = mouse.expSpecific.procFluor(xform_fluor,baseline_Fluor);
                    xform_Reflectance = mouse.expSpecific.procFluor(xform_Reflectance,baseline_Reflectance); % make the data ratiometric
                    ...
                    xform_fluorCorr = mouse.physics.correctHb(xform_fluor,xform_datahb,...
                   ...
                   switch sessionInfo.mouseType
                       ...
                       case 'jrgeco1a'                          
                            ...
                            clear xform_Reflectance
                                    ...
                                    clear xform_raw
                                   baseline_FAD= mean(xform_FAD(:,:,sessionInfo.stimbaseline+1:end),3);                             
                                   xform_FAD= mouse.expSpecific.procFluor(xform_fluor,baseline_Fluor);
                    
                     
                    baseline_green = mean(xform_green(:,:,sessionInfo.stimbaseline+1:end),3);
           
                    xform_green = mouse.expSpecific.procFluor(xform_green,baseline_green); % make the data ratiometric
    ...
    for n = runs
        ...
        if strcmp(sessionType,'fc')
            ...
            elseif strcmp(sessionInfo.mouseType,'jrgeco1a')
                ...
                [R_jrgeco1aCorr_ISA,Rs_jrgeco1aCorr_ISA] = QCcheck_CalcRRs(refseeds,double(xform_jrgeco1aCorr)/0.01,sessionInfo.framerate,xform_isbrain,[sessionInfo.bandtype_ISA{2},sessionInfo.bandtype_ISA{3}]);
                [R_FADCorr_ISA,Rs_FADCorr_ISA] = QCcheck_CalcRRs(refseeds,double(xform_FADCorr)/0.01,sessionInfo.framerate,xform_isbrain,[sessionInfo.bandtype_ISA{2},sessionInfo.bandtype_ISA{3}]);
                [R_total_ISA,Rs_total_ISA] = QCcheck_CalcRRs(refseeds,double(total)*10^6,sessionInfo.framerate,xform_isbrain,[sessionInfo.bandtype_ISA{2},sessionInfo.bandtype_ISA{3}]);
                
                [R_jrgeco1aCorr_Delta,Rs_jrgeco1aCorr_Delta] = QCcheck_CalcRRs(refseeds,double(xform_jrgeco1aCorr)/0.01,sessionInfo.framerate,xform_isbrain,[sessionInfo.bandtype_Delta{2},sessionInfo.bandtype_Delta{3}]);
                [R_FADCorr_Delta,Rs_FADCorr_Delta] = QCcheck_CalcRRs(refseeds,double(xform_FADCorr)/0.01,sessionInfo.framerate,xform_isbrain,[sessionInfo.bandtype_Delta{2},sessionInfo.bandtype_Delta{3}]);
                [R_total_Delta,Rs_total_Delta] = QCcheck_CalcRRs(refseeds,double(total)*10^6,sessionInfo.framerate,xform_isbrain,[sessionInfo.bandtype_Delta{2},sessionInfo.bandtype_Delta{3}]);
                ...
                save(fullfile(saveDir, processedName),'powerdata_jrgeco1aCorr','powerdata_jrgeco1a','powerdata_FADCorr','powerdata_total','powerdata_oxy','powerdata_deoxy',...
                    ...
                    'R_jrgeco1aCorr_Delta','Rs_jrgeco1aCorr_Delta','R_FADCorr_Delta','Rs_FADCorr_Delta','R_total_Delta','Rs_total_Delta','-append','-v7.3')
