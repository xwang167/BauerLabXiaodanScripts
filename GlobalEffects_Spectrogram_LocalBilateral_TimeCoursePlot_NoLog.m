...
for freqInd = 1:4
    ...
    for runInd=mouse_ind
        ...
        subplot(211)
        plot(T1/60,mean(abs(S1_fc_ipsi(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorFc{mouseInd},'MarkerFaceColor',colorFc{mouseInd})
        hold on
        plot(T2/60,mean(abs(S2_fc_ipsi(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorFc{mouseInd},'MarkerFaceColor',colorFc{mouseInd})
        hold on
        xlabel('Time(min)')
        ylabel('Power(\DeltaF/F/hz)')
        title('Without PS')
        subplot(212)
        plot(T1/60,mean(abs(S1_stim_ipsi(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorStim{mouseInd},'MarkerFaceColor',colorStim{mouseInd})
        hold on
        plot(T2/60,mean(abs(S2_stim_ipsi(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorStim{mouseInd},'MarkerFaceColor',colorStim{mouseInd})
        hold on
        xlabel('Time(min)')
        ylabel('Power(\DeltaF/F/hz)')
        ...
        subplot(211)
        plot(T1/60,mean(abs(S1_fc_bilat(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorFc{mouseInd},'MarkerFaceColor',colorFc{mouseInd})
        hold on
        plot(T2/60,mean(abs(S2_fc_bilat(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorFc{mouseInd},'MarkerFaceColor',colorFc{mouseInd})
        hold on
        xlabel('Time(min)')
        ylabel('Power(\DeltaF/F/hz)')
        title('Without PS')
        subplot(212)
        plot(T1/60,mean(abs(S1_stim_bilat(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorStim{mouseInd},'MarkerFaceColor',colorStim{mouseInd})
        hold on
        plot(T2/60,mean(abs(S2_stim_bilat(freqBand{freqInd}(1):freqBand{freqInd}(2),:))),'-ko',...
            'MarkerSize',10, 'MarkerEdgeColor',colorStim{mouseInd},'MarkerFaceColor',colorStim{mouseInd})
        hold on
        xlabel('Time(min)')
        ylabel('Power(\DeltaF/F/hz)')
    ...
    figure(1)
    saveas(gca,strcat('X:\Paper2\GlobalEffects\30sPS\GroupResults\30s-Ipsi-spectrogram-TimeCourse-FCandStim-',startFreq,'-',endFreq,'-noLog.fig'))
    saveas(gca,strcat('X:\Paper2\GlobalEffects\30sPS\GroupResults\30s-Ipsi-spectrogram-TimeCourse-FCandStim-',startFreq,'-',endFreq,'-noLog.png'))

    figure(2)
    saveas(gca,strcat('X:\Paper2\GlobalEffects\30sPS\GroupResults\30s-Contra-spectrogram-TimeCourse-FCandStim-',startFreq,'-',endFreq,'-noLog.fig'))
    saveas(gca,strcat('X:\Paper2\GlobalEffects\30sPS\GroupResults\30s-Contra-spectrogram-TimeCourse-FCandStim-',startFreq,'-',endFreq,'-noLog.png'))
    close all
end
