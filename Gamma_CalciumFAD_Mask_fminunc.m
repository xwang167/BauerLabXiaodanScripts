...
excelRows = [181]; % excelRows_awake = [181 183 185 228  232  236 ]; excelRows_anes = [ 202 195 204 230 234 240];
runs = 1:3;%
fs = 5;
...
%         
        tic 
        [T,W,A,r,r2,hemoPred] = interSpeciesGammaFit_CalciumHbT_Mask_fminonc(Calcium_filter*100,HbT_filter*10^6,t,mask);
        toc
