...
pause
saveas(gcf,strcat('M:\GCaMP\CodeModification\new\cat\','190506-G6M2-G7M6-G7M7-GSR-PeakMap.fig'))
saveas(gcf,strcat('M:\GCaMP\CodeModification\new\cat\','190506-G6M2-G7M6-G7M7-GSR-PeakMap.png'))
[X,Y] = meshgrid(1:128,1:128);
[x1,y1] = ginput(1);
[x2,y2] = ginput(1);
radius = sqrt((x1-x2)^2+(y1-y2)^2);
...
save('M:\GCaMP\CodeModification\new\cat\190506-G6M2-G7M6-G7M7-NoGSR.mat','datahb_ROI')
...
suptitle('G6M2-G7M6-G7M7-With GSR')
pause
saveas(gcf,strcat('M:\GCaMP\CodeModification\old\cat\','190506-G6M2-G7M6-G7M7-GSR-PeakMap.fig'))
saveas(gcf,strcat('M:\GCaMP\CodeModification\old\cat\','190506-G6M2-G7M6-G7M7-GSR-PeakMap.png'))
[X,Y] = meshgrid(1:128,1:128);
[x1,y1] = ginput(1);
[x2,y2] = ginput(1);
radius = sqrt((x1-x2)^2+(y1-y2)^2);
...
plot(datahb_ROI(1,:)+datahb_ROI(2,:),'k');
title('G6M2-G7M6-G7M7-Without GSR')
saveas(gcf,strcat('M:\GCaMP\CodeModification\old\cat\','190506-G6M2-G7M6-G7M7-NoGSR-TimeTrace.fig'))
saveas(gcf,strcat('M:\GCaMP\CodeModification\old\cat\','190506-G6M2-G7M6-G7M7-NoGSR-TimeTrace.png'))

save('M:\GCaMP\CodeModification\old\cat\190506-G6M2-G7M6-G7M7-NoGSR.mat','datahb_ROI')