...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremWT_ISA_R(y,x,1,:), TremWT5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremWT_ISA_R(:,:,1)-MeanTremWT5XFAD_ISA_R(:,:,1);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremKO_ISA_R(y,x,1,:), TremKO5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremKO_ISA_R(:,:,1)-MeanTremKO5XFAD_ISA_R(:,:,1);
...
% for y=1:16
%     for x=1:16
%         [h, p]=ttest2(TremHet_ISA_R(y,x,1,:), TremHet5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
% 
% figure;
% A=MeanTremHet_ISA_R(:,:,1)-MeanTremHet5XFAD_ISA_R(:,:,1);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremKO5XFAD_ISA_R(y,x,1,:),TremWT5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
figure;
A=TremKO5XFAD_ISA_R(:,:,1)-MeanTremWT5XFAD_ISA_R(:,:,1);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremWT_ISA_R(y,x,1,:), TremKO_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremWT_ISA_R(:,:,1)-MeanTremKO_ISA_R(:,:,1);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremWT_ISA_R(y,x,1,:), TremKO5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremWT_ISA_R(:,:,1)-MeanTremKO5XFAD_ISA_R(:,:,1);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremKO_ISA_R(y,x,1,:),TremWT5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremKO_ISA_R(:,:,1)-MeanTremWT5XFAD_ISA_R(:,:,1);
...
% for y=1:16
%     for x=1:16
%         [h, p]=ttest2(TremHet5XFAD_ISA_R(y,x,1,:), TremKO5XFAD_ISA_R(y,x,1,:), 0.05, 'both', 'unequal');
...
% 
% figure;
% A=MeanTremHet5XFAD_ISA_R(:,:,1)-MeanTremKO5XFAD_ISA_R(:,:,1);
