...
for y=1:128
    for x=1:128
        [h, p]=ttest2(TremWT_Delta_Bilat(y,x,4,:), TremWT5XFAD_Delta_Bilat(y,x,4,:), 0.05, 'both', 'unequal');
...
file1=MeanTremWT_Delta_Bilat(:,:,4);
file2=MeanTremWT5XFAD_Delta_Bilat(:,:,4);
...
for y=1:128
    for x=1:128
        [h, p]=ttest2(TremKO_Delta_Bilat(y,x,4,:), TremKO5XFAD_Delta_Bilat(y,x,4,:), 0.05, 'both', 'unequal');
...
file1=MeanTremKO_Delta_Bilat(:,:,4);
file2=MeanTremKO5XFAD_Delta_Bilat(:,:,4);
...
for y=1:128
    for x=1:128
        [h, p]=ttest2(TremHet_Delta_Bilat(y,x,4,:), TremHet5XFAD_Delta_Bilat(y,x,4,:), 0.05, 'both', 'unequal');
...
file1=MeanTremHet_Delta_Bilat(:,:,4);
file2=MeanTremHet5XFAD_Delta_Bilat(:,:,4);
...
for y=1:128
    for x=1:128
        [h, p]=ttest2(TremWT5XFAD_Delta_Bilat(y,x,4,:), TremKO5XFAD_Delta_Bilat(y,x,4,:), 0.05, 'both', 'unequal');
...
file1=MeanTremWT5XFAD_Delta_Bilat(:,:,4);
file2=MeanTremKO5XFAD_Delta_Bilat(:,:,4);
...
for y=1:128
    for x=1:128
        [h, p]=ttest2(TremHet5XFAD_Delta_Bilat(y,x,4,:), TremKO5XFAD_Delta_Bilat(y,x,4,:), 0.05, 'both', 'unequal');
...
file1=MeanTremHet5XFAD_Delta_Bilat(:,:,4);
file2=MeanTremKO5XFAD_Delta_Bilat(:,:,4);
...
for y=1:128
    for x=1:128
        [h, p]=ttest2(TremWT_Delta_Bilat(y,x,4,:), TremKO_Delta_Bilat(y,x,4,:), 0.05, 'both', 'unequal');
...
file1=MeanTremWT_Delta_Bilat(:,:,4);
file2=MeanTremKO_Delta_Bilat(:,:,4);
