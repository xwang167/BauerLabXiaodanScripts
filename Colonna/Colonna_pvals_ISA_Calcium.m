...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremWT_ISA_R(y,x,4,:), TremWT5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremWT_ISA_R(:,:,4)-MeanTremWT5XFAD_ISA_R(:,:,4);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremKO_ISA_R(y,x,4,:), TremKO5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremKO_ISA_R(:,:,4)-MeanTremKO5XFAD_ISA_R(:,:,4);
...
% for y=1:16
%     for x=1:16
%         [h, p]=ttest2(TremHet_ISA_R(y,x,4,:), TremHet5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
% 
% figure;
% A=MeanTremHet_ISA_R(:,:,4)-MeanTremHet5XFAD_ISA_R(:,:,4);
...
%% Trem KO 5XFAD vs Trem WT 5xFAD

for y=1:16
    for x=1:16
        [h, p]=ttest2(TremKO5XFAD_ISA_R(y,x,4,:),TremWT5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
        p_TremKO5xFAD_vs_TremWT5XFAD(y,x)=p;
        h_TremKO5xFAD_vs_TremWT5XFAD(y,x)=h;
    end
end

figure;
A=MeanTremKO5XFAD_ISA_R(:,:,4)-MeanTremWT5XFAD_ISA_R(:,:,4);
A=A.*h_TremKO5xFAD_vs_TremWT5XFAD;
A(A==Inf)=0;
idx=isnan(A(:));
A(idx)=0;
A(A==0)=-3;
...
set(gca,'YTickLabel',{'FL','CL','ML','SL','RL','PL','VL','AL','FR','CR','MR','SR','RR','PR','VR','AR'})
rotateXLabels(gca, 45);
title('ISA band TremKO5XFAD vs TremWT5XFAD', 'FontSize', 12);

output=['ISA band TremKO5XFAD vs TremWT5XFAD','.jpg'];
orient portrait
print ('-djpeg', '-r300', output);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremWT_ISA_R(y,x,4,:), TremKO_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremWT_ISA_R(:,:,4)-MeanTremKO_ISA_R(:,:,4);
...
output=['ISA band TremWT vs TremKO','.jpg'];
orient portrait
print ('-djpeg', '-r300', output);

%% Trem WT vs Trem KO 5FAD

for y=1:16
    for x=1:16
        [h, p]=ttest2(TremWT_ISA_R(y,x,4,:), TremKO5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremWT_ISA_R(:,:,4)-MeanTremKO5XFAD_ISA_R(:,:,4);
A=A.*h_TremWT_vs_TremKO5XFAD;
A(A==Inf)=0;
idx=isnan(A(:));
A(idx)=0;
A(A==0)=-3;
...
set(gca,'YTickLabel',{'FL','CL','ML','SL','RL','PL','VL','AL','FR','CR','MR','SR','RR','PR','VR','AR'})
rotateXLabels(gca, 45);
title('ISA band TremWT vs TremKO5XFAD', 'FontSize', 12);

output=['ISA band TremWT vs TremKO5XFAD','.jpg'];
orient portrait
print ('-djpeg', '-r300', output);
...
for y=1:16
    for x=1:16
        [h, p]=ttest2(TremKO_ISA_R(y,x,4,:),TremWT5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
figure;
A=MeanTremKO_ISA_R(:,:,4)-MeanTremWT5XFAD_ISA_R(:,:,4);
A=A.*h_TremKO_vs_TremWT5XFAD;
A(A==Inf)=0;
idx=isnan(A(:));
A(idx)=0;
A(A==0)=-3;
...
set(gca,'YTickLabel',{'FL','CL','ML','SL','RL','PL','VL','AL','FR','CR','MR','SR','RR','PR','VR','AR'})
rotateXLabels(gca, 45);
title('ISA band TremKO vs TremWT5XFAD', 'FontSize', 12);

output=['ISA band TremKO vs TremWT5XFAD','.jpg'];
orient portrait
print ('-djpeg', '-r300', output);
...
% for y=1:16
%     for x=1:16
%         [h, p]=ttest2(TremHet5XFAD_ISA_R(y,x,4,:), TremKO5XFAD_ISA_R(y,x,4,:), 0.05, 'both', 'unequal');
...
% 
% figure;
% A=MeanTremHet5XFAD_ISA_R(:,:,4)-MeanTremKO5XFAD_ISA_R(:,:,4);
