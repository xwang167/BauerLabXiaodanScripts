for ii = 1:9
    ...
    subplot(2,3,1)
    powerMapRatioVis(jrgeco1aCorr_ISA_powerMap_mice./jrgeco1aCorr_ISA_powerMap_mice_baseline,0, 2)
    title('Corr jRGECO1a')
    
    subplot(2,3,2)
    powerMapRatioVis(FADCorr_ISA_powerMap_mice./FADCorr_ISA_powerMap_mice_baseline,0, 2)
    title('Corr FAD')
    
    subplot(2,3,3)
    powerMapRatioVis(total_ISA_powerMap_mice./total_ISA_powerMap_mice_baseline,0, 2)
    title('Total')
