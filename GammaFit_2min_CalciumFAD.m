    ...
    for n = runs
        ...
        r2_CalciumFAD_2min_median = nanmedian(r2_CalciumFAD_2min,3);
         ...
         save(fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_2min','.mat')),...
            ...
            title('A')
            set(gca,'FontSize',14,'FontWeight','Bold')           
            suptitle(strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'-CalciumFAD-GammaFit-2min'))
           
            saveas(gcf,fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_CalciumFAD_GammaFit_2min.png')));
            saveas(gcf,fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_CalciumFAD_GammaFit_2min.fig')));
