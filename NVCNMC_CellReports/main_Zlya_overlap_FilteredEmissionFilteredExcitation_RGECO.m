...
excelRows = 16:22;%[3,5,7,8,10,11,12,13];%:450;
runs = 1:3;
isDetrend = 1;
nVy = 128;
nVx = 128;
...
%         mkdir(saveDir)
%     end
%     saveDir_corrected = fullfile('X:\XW\FilteredSpectra\FilteredEmissionFilteredExcitation',recDate);
...
%     systemInfo.LEDFiles = [
%         "TwoCam_Mightex470_BP_Pol_580_500.txt",...
%         "TwoCam_Mightex525_BP_Pol_580_593.txt",...
        ...
        if exist(fullfile(saveDir,processedName),'file')
            if strcmp(sessionType,'fc')
                    ...
                    disp(strcat('fc QC check on ', processedName))                   
                        ...
                        %
                        %
                        QCcheck_powerMapVis(jrgeco1aCorr_ISA_powerMap,xform_isbrain,'(\DeltaF/F%)',saveDir_corrected,strcat(visName, '_RGECOISA'))
                        ...
                        QCcheck_powerMapVis(jrgeco1aCorr_Delta_powerMap,xform_isbrain,'(\DeltaF/F%)',saveDir_corrected,strcat(visName, "_RGECODelta"))
                        ...
                        QCcheck_fcVis(refseeds,R_jrgeco1aCorr_ISA, Rs_jrgeco1aCorr_ISA,'jrgeco1aCorr','m','ISA',...
                        ...
                        QCcheck_fcVis(refseeds,R_jrgeco1aCorr_Delta, Rs_jrgeco1aCorr_Delta,'jrgeco1aCorr','m','Delta',...
                            saveDir_corrected,visName,false,xform_isbrain)
                        close all
            ...
            elseif strcmp(sessionType,'stim')
                ...
                disp('loading Non GRS data')
                 ...
                 load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim',num2str(n),'_processed.mat')),...
                        'xform_jrgeco1a','xform_red','xform_FAD','xform_green','xform_datahb')
