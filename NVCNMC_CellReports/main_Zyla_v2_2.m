...
%     if exist(fullfile(directory,wlName),'file')
%         disp(strcat('WL and transform file already exists for ', recDate,'-', mouseName))
%         load(fullfile(directory,wlName),'mytform','WL');
%     else
...
%         save(fullfile(directory,maskName),'isbrain',  'I' ,'WL','WLcrop', 'xform_WLcrop', 'xform_isbrain', 'isbrain', 'WL', 'xform_WL', 'I', 'seedcenter')
%         figure;
...
%     wlName = strcat(recDate,'-',mouseName,'-WLandTransform','.mat');
%     load(fullfile(directory,wlName),'mytform');
%     
%     
%     maskName = strcat(recDate,'-',mouseName,'-LandmarksandMarks','.mat');
%     load(fullfile(directory,maskName),'I')
%     
%     
...
%             if exist(fullfile(directory,rawName))
%                 disp(strcat('combined file already exist for ',rawName ))
%                 load(fullfile(directory,rawName),'combinedRaw')
%             else
...
%                 save(fullfile(directory,rawName),'combinedRaw','-v7.3')
%             end
...
%             save(fullfile(directory,rawName),'raw','xform_raw','-append')
%             
%             disp('get hemoglobin data');
%             
%             maskName = strcat(recDate,'-',mouseName,'-LandmarksandMarks','.mat');
%             load(fullfile(directory,maskName), 'xform_isbrain','I')
%             
...
%             xform_datahb = mouse.process.procOIS(xform_raw,baselineValues,op.dpf,E,xform_sibrain);
%             processedName = strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_processed','.mat');
