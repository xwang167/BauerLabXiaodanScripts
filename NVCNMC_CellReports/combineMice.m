...
for excelRow = excelRows
    ...
    elseif strcmp(char(sessionInfo.mouseType),'jrgeco1a')
        load(fullfile(saveDir,processedName_mouse),'xform_jrgeco1a_mouse_GSR','xform_jrgeco1aCorr_mouse_GSR','xform_red_mouse_GSR')
...
elseif strcmp(sessionType,'stim')
    ...
    elseif strcmp(char(sessionInfo.mouseType),'jrgeco1a')
        ...
        clear xform_jrgeco1a_mouse xform_jrgeco1aCorr_mouse xform_red_mouse
    end
    ...
    % Block Average
    texttitle_GSR = strcat(' Block Average for', "  " ,miceName,'-stim'," ",'without GSR');
    ...
    if strcmp(char(sessionInfo.mouseType),'gcamp6f')
        ...
        subplot(1,3,1)
        imagesc(AvgOxy_stim_GSR,[-20e-6 20e-6])
        colorbar
        axis image off
        title('Oxy')
        subplot(1,3,2)
        imagesc(AvgDeOxy_stim_GSR,[-10e-6 10e-6])
        colorbar
        axis image off
        title('DeOxy')
        subplot(1,3,3)
        imagesc(AvgTotal_stim_GSR,[-10e-6 10e-6])
        colorbar
        axis image off
        title('Total')
        colormap jet
    ...
    for excelRow = excelRows
        ...
        elseif strcmp(char(sessionInfo.mouseType),'jrgeco1a')
            load(fullfile(saveDir,processedName_mouse),'xform_jrgeco1a_mouse_NoGSR','xform_jrgeco1aCorr_mouse_NoGSR','xform_red_mouse_NoGSR')
    ...
    elseif strcmp(sessionType,'stim')
        ...
        if strcmp(char(sessionInfo.mouseType),'gcamp6f')
            ...
            green_NoGSR = double(xform_green_mice_NoGSR);
        elseif strcmp(char(sessionInfo.mouseType),'jrgeco1a')
