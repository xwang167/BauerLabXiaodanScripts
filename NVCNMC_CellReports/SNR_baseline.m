...
figure
subplot(221)
imagesc(3*std_Calcium_Uncorr_mice_awake*100,'AlphaData',mask)
axis image off
clim([0 8])
b = colorbar;
ylabel(b,'%')
...
subplot(222)
imagesc(3*std_FAD_Uncorr_mice_awake*100,'AlphaData',mask)
axis image off
clim([0 5])
b = colorbar;
ylabel(b,'%')
...
subplot(223)
imagesc(3*std_HbT_mice_awake*100,'AlphaData',mask)
axis image off
clim([0 12])
b = colorbar;
ylabel(b,'%')
...
figure
subplot(221)
imagesc(3*std_Calcium_Uncorr_mice_anes*100,'AlphaData',mask)
axis image off
clim([0 20])
b = colorbar;
ylabel(b,'%')
...
subplot(222)
imagesc(3*std_FAD_Uncorr_mice_anes*100,'AlphaData',mask)
axis image off
clim([0 5])
b = colorbar;
ylabel(b,'%')
...
subplot(223)
imagesc(3*std_HbT_mice_anes*100,'AlphaData',mask)
axis image off
clim([0 5])
b = colorbar;
ylabel(b,'%')
...
figure
subplot(221)
imagesc(3*std_Calcium_Uncorr_mice_awake./xform_eNoise_percent_mice_awake(:,:,2),'AlphaData',mask)
axis image off
clim([0 10])
colorbar
title('jRGECO1a')
...
subplot(222)
imagesc(3*std_FAD_Uncorr_mice_awake./xform_eNoise_percent_mice_awake(:,:,1),'AlphaData',mask)
axis image off
clim([0 8])
colorbar
title('FAF')
...
subplot(223)
imagesc(3*std_HbT_mice_awake./xform_eNoise_percent_mice_awake(:,:,3),'AlphaData',mask)
axis image off
clim([0 60])
colorbar
title('HbT')
...
figure
subplot(221)
imagesc(3*std_Calcium_Uncorr_mice_anes./xform_eNoise_percent_mice_anes(:,:,2),'AlphaData',mask)
axis image off
clim([0 30])
colorbar
title('jRGECO1a')
...
subplot(222)
imagesc(3*std_FAD_Uncorr_mice_anes./xform_eNoise_percent_mice_anes(:,:,1),'AlphaData',mask)
axis image off
clim([0 8])
colorbar
title('FAF')
...
subplot(223)
imagesc(3*std_HbT_mice_anes./xform_eNoise_percent_mice_anes(:,:,3),'AlphaData',mask)
axis image off
clim([0 25])
colorbar
title('HbT')
...
calcium_awake_SNR = 3*std_Calcium_Uncorr_mice_awake./xform_eNoise_percent_mice_awake(:,:,2);
calcium_awake_SNR_avg = mean(calcium_awake_SNR(logical(mask)));

FAF_awake_SNR = 3*std_FAD_Uncorr_mice_awake./xform_eNoise_percent_mice_awake(:,:,1);
FAF_awake_SNR_avg = mean(FAF_awake_SNR(logical(mask)));

HbT_awake_SNR = 3*std_HbT_mice_awake./xform_eNoise_percent_mice_awake(:,:,3);
HbT_awake_SNR_avg = mean(HbT_awake_SNR(logical(mask)));

calcium_anes_SNR = 3*std_Calcium_Uncorr_mice_anes./xform_eNoise_percent_mice_anes(:,:,2);
calcium_anes_SNR_avg = mean(calcium_anes_SNR(logical(mask)));

FAF_anes_SNR = 3*std_FAD_Uncorr_mice_anes./xform_eNoise_percent_mice_anes(:,:,1);
FAF_anes_SNR_avg = mean(FAF_anes_SNR(logical(mask)));

HbT_anes_SNR = 3*std_HbT_mice_anes./xform_eNoise_percent_mice_anes(:,:,3);
