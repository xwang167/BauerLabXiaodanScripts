function [R,Rs] = QCcheck_CalcRRs_GSR_Each(refseeds,data,framerate,xform_isbrain,freqRange)
...
disp('gsr for each hemisphere');

data = gsr_stroke2_xw(data,xform_isbrain,'Each');
