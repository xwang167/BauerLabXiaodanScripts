...
colorMax = 1;
    if isZTransform
R_fluor_band = atanh(R_fluor_band);
Rs_fluor_band = atanh(Rs_fluor_band);
colorMax = 2;
    end
...
annotation('textbox',[0.125 0.95 0.75 0.05],'HorizontalAlignment','center','LineStyle','none','String',strcat(visName," " ,bandname, " ",'Data Visualization'),'FontWeight','bold','FontSize',15,'Interpreter','none');
