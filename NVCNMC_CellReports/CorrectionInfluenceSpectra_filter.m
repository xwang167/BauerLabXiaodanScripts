...
for excelRow = [181 183 185 228 232 236 202 195 204 230 234 240]
    ...
    for n = runs
        ...
        loglog(hz,powerdata_jrgeco1aCorr_lpf,'k')
        hold on
        loglog(hz,powerdata_oxy,'m')
        hold on
        loglog(hz,powerdata_deoxy,'c')
        ...
        saveas(gcf,fullfile(saveDir_lpf,strcat(visName,'_jrgeco1aPowerSpectra.png')));
        saveas(gcf,fullfile(saveDir_lpf,strcat(visName,'_jrgeco1aPowerSpectra.fig')));
        ...
        saveas(gcf,fullfile(saveDir_lpf,strcat(visName,'_FADPowerSpectra.fig')));
