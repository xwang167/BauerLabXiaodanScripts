function runsInfo = parseRuns_xw(excelFile,excelRows)
...
%   mouse.expSpecific.sysInfo_xw that outputs various information about the
...
%   mouse.expSpecific.sysInfo_xw. Ex) 4
%
%   Hb Ch Ind (optional) = indices of channels to be used for hemoglobin
%   calculation. Default = output from mouse.expSpecific.sysInfo_xw. Ex) 1,3
%
%   Fluor Ch Ind (optional) = indices of channels to be used for
%   fluorescence calculation. Default = output from mouse.expSpecific.sysInfo_xw. Ex) 1,3
%
...
%   blue in that order. Default = output from mouse.expSpecific.sysInfo_xw.
%   Ex) 1,3,4
%
...
%   Default = output from mouse.expSpecific.sysInfo_xw. Ex) 1,16382
%
...
%   mouse.expSpecific.sysInfo_xw. Ex) 5
%
...
%   spatially. Default = output from mouse.expSpecific.sysInfo_xw. Ex) 4,4,4,1
