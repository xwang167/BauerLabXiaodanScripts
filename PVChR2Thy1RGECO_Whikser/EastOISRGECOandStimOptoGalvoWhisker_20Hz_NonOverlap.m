function EastOISRGECOandStimOptoGalvoWhisker_20Hz_NonOverlap(ST, OptoStim, GalvoSeedCenter)
%DaqReset
%% Scanning Variables
...
CCDVec(sum(SpF(1:3))+1:sum(SpF(1:3))+SpF(4)-readOutTime,1) = 1; % Laser Channel
...
switch OptoStim
    ...
    case 'On'               % Use for stimulating in a block design
        ...
        BL2=60-(BL1+Dur);   % Baseline  time (stimulus off)%Xiaodan Wang
