...
for excelRow = excelRows
   ...
   xform_isbrain_mice = xform_isbrain_mice.*xform_isbrain;
    ...
    figure;
    colormap jet;
    subplot(2,2,1); imagesc(lagTimeTrial_HbTCalcium_2min_median_mouse,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('Calcium HbT');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
    subplot(2,2,2); imagesc(lagTimeTrial_FADCalcium_2min_median_mouse,[0 0.3]);axis image off;h = colorbar;ylabel(h,'t(s)');title('Calcium FAD');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')   
    ...
    suptitle(strcat(recDate,'-',mouseName,'-',sessionType,'-2min'))
...
subplot(2,2,1); imagesc(lagTimeTrial_HbTCalcium_2min_median_mice,tLim); cmocean('ice');axis image off;h = colorbar;ylabel(h,'t(s)');title('Calcium HbT');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
subplot(2,2,2); imagesc(lagTimeTrial_FADCalcium_2min_median_mice,[0 0.3]);cmocean('ice');axis image off;h = colorbar;ylabel(h,'t(s)');title('Calcium FAD');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')

suptitle('Awake Cross Correlation 2min')
...
figure;
colormap jet;
subplot(2,2,1); imagesc(lagTimeTrial_HbTCalcium_2min_median_mice,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('Calcium HbT');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
subplot(2,2,2); imagesc(lagTimeTrial_FADCalcium_2min_median_mice,[0 0.3]);axis image off;h = colorbar;ylabel(h,'t(s)');title('Calcium FAD');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
...
suptitle('Anes Cross Correlation 2min')
saveas(gcf,fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-',sessionType,'_Lag_2min.png')));
saveas(gcf,fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-',sessionType,'_Lag_2min.fig')));
