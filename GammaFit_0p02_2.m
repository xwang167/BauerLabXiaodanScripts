...
% 
                ...
                tLim_FAD = [0 0.3];
                rLim = [-1 1];
                disp(strcat('Gamma fit analysis on ', recDate, '', mouseName, ' run#', num2str(n)))
% % 
                        
                                
                [T,W,A,r,r2,hemoPred] = interSpeciesGammaFit(xform_jrgeco1aCorr_filtered,xform_total_filtered);
                t = T./fs;
                w = W./fs;
