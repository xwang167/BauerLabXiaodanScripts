...
if ~isempty(jrgeco1a)
    [goodBlocks] = pickGoodBlocks(stimStartTime,stimEndTime,numBlock,oxy_downsampled,deoxy_downsampled,total_downsampled,[],jrgeco1a_downsampled,input_ROI);
...
%     saveas(gcf,strcat(output,'Hbpeak.png'))
    ...
    if ~isempty(jrgeco1a)
        traceImage(jrgeco1a_downsampled_blocks,jrgeco1aCorr_downsampled_blocks,red_downsampled_blocks,...
            ...
            stimduration, stimblocksize, stimFreq, framerate, stimbaseline,stimStartTime,stimEndTime,xform_isbrain,[maxRGECO maxRGECO maxRGECO/4])
