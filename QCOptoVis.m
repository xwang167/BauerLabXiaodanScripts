...
%     for n = runs
%         load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim',num2str(n),'_processed.mat')),'xform_jrgeco1aCorr_GSR')
...
texttitle_GSR = strcat(mouseName,'-stim'," ",'with GSR, HbO to 1hz');
    ...
    load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'ROI_GSR','peakMap_ROI','xform_jrgeco1aCorr_mouse_GSR','xform_jrgeco1a_mouse_GSR','xform_red_mouse_GSR',...
    ...
    close all
%     save(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'ROI_GSR','peakMap_ROI','xform_datahb_mouse_GSR_filtered','xform_jrgeco1aCorr_mouse_GSR','xform_jrgeco1a_mouse_GSR','xform_red_mouse_GSR',...
%         'oxy_downsampled_mouse_GSR','deoxy_downsampled_mouse_GSR','jrgeco1a_downsampled_mouse_GSR','jrgeco1aCorr_downsampled_mouse_GSR','red_downsampled_mouse_GSR')
    save(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_datahb_mouse_GSR_filtered','-append')
...
%     disp('loading GRS data')
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_jrgeco1aCorr_mouse_GSR')
...
%     
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_jrgeco1a_mouse_GSR')
...
%     
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_red_mouse_GSR')
...
%     clear xform_red_mouse_GSR
    ...
    load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_datahb_mouse_GSR_filtered')
...
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'oxy_downsampled_mouse_GSR')
...
%     
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'deoxy_downsampled_mouse_GSR')
...
%     
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'jrgeco1a_downsampled_mouse_GSR')
...
%     
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'jrgeco1aCorr_downsampled_mouse_GSR')
...
%     
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'red_downsampled_mouse_GSR')
...
%     
%     load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'peakMap_ROI')    
...
% red_downsampled_mice_GSR = mean(red_downsampled_mice_GSR,4);
 load(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'ROI','peakMap_ROI_mice','xform_jrgeco1aCorr_mice_GSR','xform_jrgeco1a_mice_GSR','xform_red_mice_GSR',...
        'oxy_downsampled_mice_GSR','deoxy_downsampled_mice_GSR','jrgeco1a_downsampled_mice_GSR','jrgeco1aCorr_downsampled_mice_GSR','red_downsampled_mice_GSR')

    if strcmp(sessionInfo.mouseType,'jrgeco1a-opto3')
            texttitle_GSR = strcat(miceName,'-stim'," ",'with GSR, HbO to 1hz');
    output_GSR= fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim','-GSR'));
        QC_stim(oxy_downsampled_mice_GSR,oxy_downsampled_mice_GSR,deoxy_downsampled_mice_GSR,deoxy_downsampled_mice_GSR,...
            ...
            xform_isbrain,1,stimStartTime,sessionInfo.stimduration,sessionInfo.stimFrequency,sessionInfo.framerate,sessionInfo.stimblocksize,sessionInfo.stimbaseline,texttitle_GSR,output_GSR,ROI);
    end
    close all
    
    save(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'xform_datahb_mice_GSR_filtered','-append')
%     save(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'ROI','peakMap_ROI_mice','xform_jrgeco1aCorr_mice_GSR','xform_jrgeco1a_mice_GSR','xform_red_mice_GSR',...
%         'oxy_downsampled_mice_GSR','deoxy_downsampled_mice_GSR','jrgeco1a_downsampled_mice_GSR','jrgeco1aCorr_downsampled_mice_GSR','red_downsampled_mice_GSR')
