...
for excelRow = excelRows
    ...
    load(fullfile(maskDir,strcat(recDate,'-',mouseName,'-LandmarksAndMask','.mat')),'xform_isbrain');
...
%     disp('QC on non GSR stim')
    ...
    clear xofrm_datahb_mice_NoGSR xform_gcamp_mice_NoGSR xform_gcampCorr_mice_NoGSR xform_green_mice_NoGSR
    ...
    clear xofrm_datahb_mice_GSR   xform_gcamp_mice_GSR xform_gcampCorr_mice_GSR xform_green_mice_GSR
