...
% sort
[T_HRF_mice_awake_exclude_mean_sort,I_T_awake] = sort(T_HRF_mice_awake_exclude_mean);
T_MRF_mice_awake_exclude_mean_sort = T_MRF_mice_awake_exclude_mean(I_T_awake);
label_region_T_awake = label_region(I_T_awake);
r_T_awake_mean = corr(T_HRF_mice_awake_exclude_mean_sort,T_MRF_mice_awake_exclude_mean_sort);

[T_HRF_mice_anes_exclude_mean_sort,I_T_anes] = sort(T_HRF_mice_anes_exclude_mean);
T_MRF_mice_anes_exclude_mean_sort = T_MRF_mice_anes_exclude_mean(I_T_anes);
label_region_T_anes = label_region(I_T_anes);
r_T_anes_mean = corr(T_HRF_mice_anes_exclude_mean_sort,T_MRF_mice_anes_exclude_mean_sort);
...
subplot(211)
yyaxis left
scatter(1:44,T_HRF_mice_awake_exclude_mean_sort,'filled')
ylabel('NVC T(s)')
hold on
yyaxis right
scatter(1:44,T_MRF_mice_awake_exclude_mean_sort,'filled','d')
ylabel('NMC T(s)')
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
title(['Awake, r = ',num2str(r_T_awake_mean)])
subplot(212)
yyaxis left
scatter(1:44,T_HRF_mice_anes_exclude_mean_sort,'filled')
ylabel('NVC T(s)')
hold on
yyaxis right
scatter(1:44,T_MRF_mice_anes_exclude_mean_sort,'filled','d')
ylabel('NMC T(s)')
title(['Anesthetized, r = ',num2str(r_T_anes_mean)])
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
% sort
[W_HRF_mice_awake_exclude_mean_sort,I_W_awake] = sort(W_HRF_mice_awake_exclude_mean);
W_MRF_mice_awake_exclude_mean_sort = W_MRF_mice_awake_exclude_mean(I_W_awake);
label_region_W_awake = label_region(I_W_awake);
r_W_awake_mean = corr(W_HRF_mice_awake_exclude_mean_sort,W_MRF_mice_awake_exclude_mean_sort);

[W_HRF_mice_anes_exclude_mean_sort,I_W_anes] = sort(W_HRF_mice_anes_exclude_mean);
W_MRF_mice_anes_exclude_mean_sort = W_MRF_mice_anes_exclude_mean(I_W_anes);
label_region_W_anes = label_region(I_W_anes);
r_W_anes_mean = corr(W_HRF_mice_anes_exclude_mean_sort,W_MRF_mice_anes_exclude_mean_sort);

figure('units','normalized','outerposition',[0 0 1 1])
subplot(211)
yyaxis left
scatter(1:44,W_HRF_mice_awake_exclude_mean_sort,'filled')
ylabel('NVC W(s)')
hold on
yyaxis right
scatter(1:44,W_MRF_mice_awake_exclude_mean_sort,'filled','d')
ylabel('NMC W(s)')
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
a = get(gca,'XTickLabel');
set(gca,'XTickLabel',a,'FontName','Times','fontsize',18)
title(['Awake, r = ',num2str(r_W_awake_mean)])

subplot(212)
yyaxis left
scatter(1:44,W_HRF_mice_anes_exclude_mean_sort,'filled')
ylabel('NVC W(s)')
hold on
yyaxis right
scatter(1:44,W_MRF_mice_anes_exclude_mean_sort,'filled','d')
ylabel('NMC W(s)')
title(['Anesthetized, r = ',num2str(r_W_anes_mean)])
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
% sort
[A_HRF_mice_awake_exclude_mean_sort,I_A_awake] = sort(A_HRF_mice_awake_exclude_mean);
A_MRF_mice_awake_exclude_mean_sort = A_MRF_mice_awake_exclude_mean(I_A_awake);
label_region_A_awake = label_region(I_A_awake);
r_A_awake_mean = corr(A_HRF_mice_awake_exclude_mean_sort,A_MRF_mice_awake_exclude_mean_sort);

[A_HRF_mice_anes_exclude_mean_sort,I_A_anes] = sort(A_HRF_mice_anes_exclude_mean);
A_MRF_mice_anes_exclude_mean_sort = A_MRF_mice_anes_exclude_mean(I_A_anes);
label_region_A_anes = label_region(I_A_anes);
r_A_anes_mean = corr(A_HRF_mice_anes_exclude_mean_sort,A_MRF_mice_anes_exclude_mean_sort);

figure('units','normalized','outerposition',[0 0 1 1])
subplot(211)
yyaxis left
scatter(1:44,A_HRF_mice_awake_exclude_mean_sort,'filled')
ylabel('NVC A')
hold on
yyaxis right
scatter(1:44,A_MRF_mice_awake_exclude_mean_sort,'filled','d')
ylabel('NMC A')
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
a = get(gca,'XTickLabel');
set(gca,'XTickLabel',a,'FontName','Times','fontsize',18)
title(['Awake, r = ',num2str(r_A_awake_mean)])

subplot(212)
yyaxis left
scatter(1:44,A_HRF_mice_anes_exclude_mean_sort,'filled')
ylabel('NVC A')
hold on
yyaxis right
scatter(1:44,A_MRF_mice_anes_exclude_mean_sort,'filled','d')
ylabel('NMC A')
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
a = get(gca,'XTickLabel');
set(gca,'XTickLabel',a,'FontName','Times','fontsize',18)
title(['Anesthetized, r = ',num2str(r_A_anes_mean)])
...
% mean
r_HRF_mice_awake_exclude_mean = nanmean(r_HRF_mice_awake_exclude,2);
r_MRF_mice_awake_exclude_mean = nanmean(r_MRF_mice_awake_exclude,2);

r_HRF_mice_anes_exclude_mean  = nanmean(r_HRF_mice_anes_exclude,2);
r_MRF_mice_anes_exclude_mean  = nanmean(r_MRF_mice_anes_exclude,2);

% sort
[r_HRF_mice_awake_exclude_mean_sort,I_r_awake] = sort(r_HRF_mice_awake_exclude_mean);
r_MRF_mice_awake_exclude_mean_sort = r_MRF_mice_awake_exclude_mean(I_r_awake);
label_region_r_awake = label_region(I_r_awake);
r_r_awake_mean = corr(r_HRF_mice_awake_exclude_mean_sort,r_MRF_mice_awake_exclude_mean_sort);

[r_HRF_mice_anes_exclude_mean_sort,I_r_anes] = sort(r_HRF_mice_anes_exclude_mean);
r_MRF_mice_anes_exclude_mean_sort = r_MRF_mice_anes_exclude_mean(I_r_anes);
label_region_r_anes = label_region(I_r_anes);
r_r_anes_mean = corr(r_HRF_mice_anes_exclude_mean_sort,r_MRF_mice_anes_exclude_mean_sort);

figure('units','normalized','outerposition',[0 0 1 1])
subplot(211)
yyaxis left
scatter(1:44,r_HRF_mice_awake_exclude_mean_sort,'filled')
ylabel('NVC r')
hold on
yyaxis right
scatter(1:44,r_MRF_mice_awake_exclude_mean_sort,'filled','d')
ylabel('NMC r')
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
a = get(gca,'XTickLabel');
set(gca,'XTickLabel',a,'FontName','Times','fontsize',18)
title(['Awake, r = ',num2str(r_r_awake_mean)])

subplot(212)
yyaxis left
scatter(1:44,r_HRF_mice_anes_exclude_mean_sort,'filled')
ylabel('NVC r')
hold on
yyaxis right
scatter(1:44,r_MRF_mice_anes_exclude_mean_sort,'filled','d')
ylabel('NMC r')
xlabel('Region')
xticks([1:44])
xtickangle(0)
...
a = get(gca,'XTickLabel');
set(gca,'XTickLabel',a,'FontName','Times','fontsize',18)
title(['Anesthetized, r = ',num2str(r_r_anes_mean)])
