...
%         dpOut = op_out.dpf/2;
%         
%         xform_gcampCorr_1p5_0 = correctHb_differentBeta(xform_gcamp,xform_datahb,[E_in(1) E_out(1)],[E_in(2) E_out(2)],dpIn,dpOut,1.5,0);
%         xform_gcampCorr_1p5_0= process.smoothImage(xform_gcampCorr_1p5_0,systemInfo.gbox,systemInfo.gsigma);
%         
%         xform_total = squeeze(xform_datahb(:,:,1,:)+ xform_datahb(:,:,2,:));
%         clear xform_datahb
%         xform_total(isinf(xform_total)) = 0;
%         xform_total(isnan(xform_total)) = 0;
%         xform_gcampCorr_1p5_0(isinf(xform_gcampCorr_1p5_0)) = 0;
%         xform_gcampCorr_1p5_0(isnan(xform_gcampCorr_1p5_0)) = 0;
%         
%         
%         
...
%         
%         xform_gcampCorr_1p5_0_filtered = mouse.freq.filterData(double(xform_gcampCorr_1p5_0),0.02,2,sessionInfo.framerate );
%         edgeLen =1;
%         tZone = 4;
%         corrThr = 0;
...
%             xform_total_filtered,xform_gcampCorr_1p5_0_filtered,edgeLen,validRange,corrThr, true,true);
%         lagTimeTrial_HbTCalcium = lagTimeTrial_HbTCalcium./sessionInfo.framerate;
%         
%         clear clear xform_total_filtered xform_FADCorr_filtered xform_gcampCorr_1p5_0_filtered
%         figure;
%         colormap jet;
%         subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);
...
for excelRow = excelRows
    ...
    figure;
    colormap jet;
    subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mouse_mean,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')
    ...
    figure;
    colormap jet;
    subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mouse_median,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')
   
    subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mouse_median,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')
...
figure;
colormap jet;
subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mice_mean,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')

subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mice_mean,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')
...
figure;
colormap jet;
subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mice_median,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')
subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mice_median,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask_new);set(gca,'FontSize',14,'FontWeight','Bold')
