...
mrf_Barrel_0p02_2_mice_awake =mrf_Barrel_0p02_2_mice;
qualifiedNum_awake = qualifiedNum;
totalNum_awake = totalNum;
mrf_Barrel_0p02_2_mice_median_awake = median(mrf_Barrel_0p02_2_mice_awake);
r_Barrel_0p02_2_mrf_mice_median_awake = median(r_Barrel_0p02_2_mrf_mice);
[pks_awake,locs_awake,w_awake,p_awake] = findpeaks(mrf_Barrel_0p02_2_mice_median_awake,t,'MinPeakProminence',2e-9);
...
mrf_Barrel_0p02_2_mice_anes =mrf_Barrel_0p02_2_mice;
qualifiedNum_anes = qualifiedNum;
totalNum_anes = totalNum;
mrf_Barrel_0p02_2_mice_median_anes = median(mrf_Barrel_0p02_2_mice_anes);
r_Barrel_0p02_2_mrf_mice_median_anes = median(r_Barrel_0p02_2_mrf_mice);

[pks_anes,locs_anes,w_anes,p_anes] = findpeaks(mrf_Barrel_0p02_2_mice_median_anes,t,'MinPeakProminence',2e-11);

figure('units','normalized','outerposition',[0 0 1 1])
subplot(2,2,1)
plot_distribution_prctile(t,mrf_Barrel_0p02_2_mice_awake,'Color',[1 0 0])
legend('25%-75%')
xlim([-3 7])
xlabel('Time(s)')
grid on
title(strcat('For awake: Median: T=',num2str(locs_awake,'%4.2f'),'s, W=',num2str(w_awake,'%4.2f'),'s, A=',num2str(pks_awake,'%4.2f'),', r=',num2str(r_Barrel_0p02_2_mrf_mice_median_awake,'%4.2f')))

subplot(2,2,2)
plot_distribution_prctile(t,mrf_Barrel_0p02_2_mice_anes,'Color',[0 0 1])
legend('25%-75%')
xlim([-3 7])
xlabel('Time(s)')
grid on
title(strcat('For anesthetized: Median: T=',num2str(locs_anes,'%4.2f'),'s, W=',num2str(w_anes,'%4.2f'),'s, A=',num2str(pks_anes,'%4.2f'),', r=',num2str(r_Barrel_0p02_2_mrf_mice_median_anes,'%4.2f')))
...
sgtitle('mrf for Left Barrel Cortex without GSR with 0.02-2Hz Filter')