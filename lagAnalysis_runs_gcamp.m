...
excelRows = 131:2:139;%[181,183,185,228,232,236];%321:327;
...
% 
        if strcmp(sessionType,'fc')
            ...
            if strcmp(sessionInfo.mouseType,'gcamp6f')
                ...
                xform_gcampCorr_filtered = mouse.freq.filterData(double(xform_gcampCorr),0.02,2,fs);
                edgeLen =1;
                tZone = 4;
                corrThr = 0.3;
...
% 
                                ...
                                figure;
                                colormap jet;
                                subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask);
                                   subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask);
                                ...
                                save(fullfile(saveDir,processedName),'lagTimeTrial_HbTCalcium', 'lagAmpTrial_HbTCalcium','-append');
                                close all
...
%                 corrThr = 0;
%                 [lagTime_GS_Calcium_ISA,lagAmp_GS_Calcium_ISA] = calcLagGS(squeeze(xform_gcampCorr),ISA(1),ISA(2),fs,edgeLen,validRange,corrThr);
...
%                 [lagTime_GS_Calcium_Delta,lagAmp_GS_Calcium_Delta] = calcLagGS(squeeze(xform_gcampCorr),Delta(1),Delta(2),fs,edgeLen,validRange,corrThr);
% 
...
excelRows = 131:2:139;%[195 202 204 230 234 240];%[195 202 204 181 183 185];
miceCat = 'Awake GCaMP';
...
traceStrs = ["total","Calcium"];

avgWayStrs = ["mean","median"];
lagSpeciesStrs = ["HbTCalcium"];
        ...
        if strcmp(sessionType,'fc')
            ...
            if strcmp(sessionInfo.mouseType,'gcamp6f')
                ...
                for ii = 1:2
                        ...
                        eval(strcat(lagParaStrs(ii),'Trial_',lagSpeciesStrs(1),'_mouse(:,:,n)','= ',lagParaStrs(ii),'Trial_',lagSpeciesStrs(jj),';'));
...
%     end
    ...
    figure;
    colormap jet;
    subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mouse_mean,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
       subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mouse_mean,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
    ...
    figure;
    colormap jet;
    subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mouse_median,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
     subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mouse_median,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
    ...
    save(fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,'_processed.mat')),...
        ...
        'lagTimeTrial_HbTCalcium_mouse_median', 'lagAmpTrial_HbTCalcium_mouse_median',...
        '-append');
...
figure;
colormap jet;
subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mice_mean,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mice_mean,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
...
figure;
colormap jet;
subplot(2,1,1); imagesc(lagTimeTrial_HbTCalcium_mice_median,tLim); axis image off;h = colorbar;ylabel(h,'t(s)');title('HbT Calcium');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
subplot(2,1,2); imagesc(lagAmpTrial_HbTCalcium_mice_median,rLim);axis image off;h = colorbar;ylabel(h,'r');hold on;imagesc(xform_WL,'AlphaData',1-mask);set(gca,'FontSize',14,'FontWeight','Bold')
...
save(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-',sessionType,'_processed.mat')),...
    'lagTimeTrial_HbTCalcium_mice_mean', 'lagAmpTrial_HbTCalcium_mice_mean',...
    'lagTimeTrial_HbTCalcium_mice_median', 'lagAmpTrial_HbTCalcium_mice_median',...
    '-append');
