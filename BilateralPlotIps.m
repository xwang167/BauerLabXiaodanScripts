...
%     
    for ii = 1:3
        for jj = 1:2
              ...
              eval(strcat('CL_R_',contrast(ii),'_',freqBand(jj),'_mouse = Rs_',contrast(ii), '_',freqBand(jj),'_mouse(2,10);'));
            eval(strcat('CL_R_',contrast(ii),'_',freqBand(jj),'_mice(ll) = atanh(CL_R_',contrast(ii),'_',freqBand(jj),'_mouse);'));
            
            eval(strcat('ML_R_',contrast(ii),'_',freqBand(jj),'_mouse = Rs_',contrast(ii), '_',freqBand(jj),'_mouse(3,11);'));
            ...
            eval(strcat('RSL_R_',contrast(ii),'_',freqBand(jj),'_mouse = Rs_',contrast(ii), '_',freqBand(jj),'_mouse(5,13);'));
            eval(strcat('RSL_R_',contrast(ii),'_',freqBand(jj),'_mice(ll) = atanh(RSL_R_',contrast(ii),'_',freqBand(jj),'_mouse);'));
            
            eval(strcat('PL_R_',contrast(ii),'_',freqBand(jj),'_mouse = Rs_',contrast(ii), '_',freqBand(jj),'_mouse(6,14);'));
            eval(strcat('PL_R_',contrast(ii),'_',freqBand(jj),'_mice(ll) = atanh(PL_R_',contrast(ii),'_',freqBand(jj),'_mouse);'));
            
            eval(strcat('VL_R_',contrast(ii),'_',freqBand(jj),'_mouse = Rs_',contrast(ii), '_',freqBand(jj),'_mouse(7,15);'));
            eval(strcat('VL_R_',contrast(ii),'_',freqBand(jj),'_mice(ll) = atanh(VL_R_',contrast(ii),'_',freqBand(jj),'_mouse);'));
            
            eval(strcat('SSL_ML_',contrast(ii),'_',freqBand(jj),'_mouse = Rs_',contrast(ii), '_',freqBand(jj),'_mouse(4,3);'));
...
[h_CL_R_ISA_CalciumFAD,p_CL_R_ISA_CalciumFAD] = ttest2(CL_R_jrgeco1aCorr_ISA_mice,CL_R_FADCorr_ISA_mice);
[h_CL_R_ISA_CalciumHbT,p_CL_R_ISA_CalciumHbT] = ttest2(CL_R_jrgeco1aCorr_ISA_mice,CL_R_total_ISA_mice);
[h_CL_R_ISA_FADHbT,p_CL_R_ISA_FADHbT] = ttest2(CL_R_FADCorr_ISA_mice,CL_R_total_ISA_mice);

[h_ML_R_ISA_CalciumFAD,p_ML_R_ISA_CalciumFAD] = ttest2(ML_R_jrgeco1aCorr_ISA_mice,ML_R_FADCorr_ISA_mice);
[h_ML_R_ISA_CalciumHbT,p_ML_R_ISA_CalciumHbT] = ttest2(ML_R_jrgeco1aCorr_ISA_mice,ML_R_total_ISA_mice);
[h_ML_R_ISA_FADHbT,p_ML_R_ISA_FADHbT] = ttest2(ML_R_FADCorr_ISA_mice,ML_R_total_ISA_mice);

[h_SSL_R_ISA_CalciumFAD,p_SSL_R_ISA_CalciumFAD] = ttest2(SSL_R_jrgeco1aCorr_ISA_mice,SSL_R_FADCorr_ISA_mice);
[h_SSL_R_ISA_CalciumHbT,p_SSL_R_ISA_CalciumHbT] = ttest2(SSL_R_jrgeco1aCorr_ISA_mice,SSL_R_total_ISA_mice);
[h_SSL_R_ISA_FADHbT,p_SSL_R_ISA_FADHbT] = ttest2(SSL_R_FADCorr_ISA_mice,SSL_R_total_ISA_mice);

[h_RSL_R_ISA_CalciumFAD,p_RSL_R_ISA_CalciumFAD] = ttest2(RSL_R_jrgeco1aCorr_ISA_mice,RSL_R_FADCorr_ISA_mice);
[h_RSL_R_ISA_CalciumHbT,p_RSL_R_ISA_CalciumHbT] = ttest2(RSL_R_jrgeco1aCorr_ISA_mice,RSL_R_total_ISA_mice);
[h_RSL_R_ISA_FADHbT,p_RSL_R_ISA_FADHbT] = ttest2(RSL_R_FADCorr_ISA_mice,RSL_R_total_ISA_mice);

[h_PL_R_ISA_CalciumFAD,p_PL_R_ISA_CalciumFAD] = ttest2(PL_R_jrgeco1aCorr_ISA_mice,PL_R_FADCorr_ISA_mice);
[h_PL_R_ISA_CalciumHbT,p_PL_R_ISA_CalciumHbT] = ttest2(PL_R_jrgeco1aCorr_ISA_mice,PL_R_total_ISA_mice);
[h_PL_R_ISA_FADHbT,p_PL_R_ISA_FADHbT] = ttest2(PL_R_FADCorr_ISA_mice,PL_R_total_ISA_mice);

[h_VL_R_ISA_CalciumFAD,p_VL_R_ISA_CalciumFAD] = ttest2(VL_R_jrgeco1aCorr_ISA_mice,VL_R_FADCorr_ISA_mice);
[h_VL_R_ISA_CalciumHbT,p_VL_R_ISA_CalciumHbT] = ttest2(VL_R_jrgeco1aCorr_ISA_mice,VL_R_total_ISA_mice);
[h_VL_R_ISA_FADHbT,p_VL_R_ISA_FADHbT] = ttest2(VL_R_FADCorr_ISA_mice,VL_R_total_ISA_mice);

[h_SSL_ML_ISA_CalciumFAD,p_SSL_ML_ISA_CalciumFAD] = ttest2(SSL_ML_jrgeco1aCorr_ISA_mice,SSL_ML_FADCorr_ISA_mice);
[h_SSL_ML_ISA_CalciumHbT,p_SSL_ML_ISA_CalciumHbT] = ttest2(SSL_ML_jrgeco1aCorr_ISA_mice,SSL_ML_total_ISA_mice);
[h_SSL_ML_ISA_FADHbT,p_SSL_ML_ISA_FADHbT] = ttest2(SSL_ML_FADCorr_ISA_mice,SSL_ML_total_ISA_mice);
...
[h_CL_R_Delta_CalciumFAD,p_CL_R_Delta_CalciumFAD] = ttest2(CL_R_jrgeco1aCorr_Delta_mice,CL_R_FADCorr_Delta_mice);
[h_CL_R_Delta_CalciumHbT,p_CL_R_Delta_CalciumHbT] = ttest2(CL_R_jrgeco1aCorr_Delta_mice,CL_R_total_Delta_mice);
[h_CL_R_Delta_FADHbT,p_CL_R_Delta_FADHbT] = ttest2(CL_R_FADCorr_Delta_mice,CL_R_total_Delta_mice);

[h_ML_R_Delta_CalciumFAD,p_ML_R_Delta_CalciumFAD] = ttest2(ML_R_jrgeco1aCorr_Delta_mice,ML_R_FADCorr_Delta_mice);
[h_ML_R_Delta_CalciumHbT,p_ML_R_Delta_CalciumHbT] = ttest2(ML_R_jrgeco1aCorr_Delta_mice,ML_R_total_Delta_mice);
[h_ML_R_Delta_FADHbT,p_ML_R_Delta_FADHbT] = ttest2(ML_R_FADCorr_Delta_mice,ML_R_total_Delta_mice);

[h_SSL_R_Delta_CalciumFAD,p_SSL_R_Delta_CalciumFAD] = ttest2(SSL_R_jrgeco1aCorr_Delta_mice,SSL_R_FADCorr_Delta_mice);
[h_SSL_R_Delta_CalciumHbT,p_SSL_R_Delta_CalciumHbT] = ttest2(SSL_R_jrgeco1aCorr_Delta_mice,SSL_R_total_Delta_mice);
[h_SSL_R_Delta_FADHbT,p_SSL_R_Delta_FADHbT] = ttest2(SSL_R_FADCorr_Delta_mice,SSL_R_total_Delta_mice);

[h_RSL_R_Delta_CalciumFAD,p_RSL_R_Delta_CalciumFAD] = ttest2(RSL_R_jrgeco1aCorr_Delta_mice,RSL_R_FADCorr_Delta_mice);
[h_RSL_R_Delta_CalciumHbT,p_RSL_R_Delta_CalciumHbT] = ttest2(RSL_R_jrgeco1aCorr_Delta_mice,RSL_R_total_Delta_mice);
[h_RSL_R_Delta_FADHbT,p_RSL_R_Delta_FADHbT] = ttest2(RSL_R_FADCorr_Delta_mice,RSL_R_total_Delta_mice);

[h_PL_R_Delta_CalciumFAD,p_PL_R_Delta_CalciumFAD] = ttest2(PL_R_jrgeco1aCorr_Delta_mice,PL_R_FADCorr_Delta_mice);
[h_PL_R_Delta_CalciumHbT,p_PL_R_Delta_CalciumHbT] = ttest2(PL_R_jrgeco1aCorr_Delta_mice,PL_R_total_Delta_mice);
[h_PL_R_Delta_FADHbT,p_PL_R_Delta_FADHbT] = ttest2(PL_R_FADCorr_Delta_mice,PL_R_total_Delta_mice);

[h_VL_R_Delta_CalciumFAD,p_VL_R_Delta_CalciumFAD] = ttest2(VL_R_jrgeco1aCorr_Delta_mice,VL_R_FADCorr_Delta_mice);
[h_VL_R_Delta_CalciumHbT,p_VL_R_Delta_CalciumHbT] = ttest2(VL_R_jrgeco1aCorr_Delta_mice,VL_R_total_Delta_mice);
[h_VL_R_Delta_FADHbT,p_VL_R_Delta_FADHbT] = ttest2(VL_R_FADCorr_Delta_mice,VL_R_total_Delta_mice);

[h_SSL_ML_Delta_CalciumFAD,p_SSL_ML_Delta_CalciumFAD] = ttest2(SSL_ML_jrgeco1aCorr_Delta_mice,SSL_ML_FADCorr_Delta_mice);
[h_SSL_ML_Delta_CalciumHbT,p_SSL_ML_Delta_CalciumHbT] = ttest2(SSL_ML_jrgeco1aCorr_Delta_mice,SSL_ML_total_Delta_mice);
[h_SSL_ML_Delta_FADHbT,p_SSL_ML_Delta_FADHbT] = ttest2(SSL_ML_FADCorr_Delta_mice,SSL_ML_total_Delta_mice);
