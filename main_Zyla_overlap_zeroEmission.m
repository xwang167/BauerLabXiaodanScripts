...
excelRows = [17:19,21:23];%[3,5,7,8,10,11,12,13];%:450;
runs = 1:3;
isDetrend = 1;
nVy = 128;
nVx = 128;
...
%         
%         clear raw_unregistered
%         load('X:\XW\Paper\WT\ZeroEmission\210830\210830-WL-LandmarksAndMask.mat','transformMat')
...
for excelRow = excelRows
    ...
    sessionInfo.fluorEmissionFile = "zero_emission.txt";
