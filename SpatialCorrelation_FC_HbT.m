...
%     'FCMatrix_HbT_0p02_mice', 'FCMatrix_HbT_0p04_mice', 'FCMatrix_HbT_0p08_mice', ...
%     'FCMatrix_HbT_0p16_mice', 'FCMatrix_HbT_0p32_mice', 'FCMatrix_HbT_0p64_mice', ...
...
% SpatialCorrelation_HbT_awake = nan(7);
% 
% for ii = 1:7
%     for jj = 1:7
...
% 
% 
% load('191030--R5M2286-anes-R5M2285-anes-R5M2288-anes-R6M2460-anes-R6M1-anes-R6M2497-anes-fc_fcMatrix_mice_noGSR.mat', 'FCMatrix_HbT_0p02_mice', 'FCMatrix_HbT_0p04_mice', 'FCMatrix_HbT_0p08_mice', 'FCMatrix_HbT_0p16_mice', 'FCMatrix_HbT_0p32_mice', 'FCMatrix_HbT_0p64_mice', 'FCMatrix_HbT_1p28_mice')
% SpatialCorrelation_HbT_anes = nan(7);
% 
% for ii = 1:7
%     for jj = 1:7
...
% 
% 
% SpatialCorrelation_HbT_awake_anes = nan(7);
% for ii = 1:7
%     for jj = 1:7
...
% end
% 
% save('L:\RGECO\cat\spatialCorrelation.mat','SpatialCorrelation_HbT_anes','SpatialCorrelation_HbT_awake','SpatialCorrelation_HbT_awake_anes')
% 
% 
...
load('191030--R5M2286-anes-R5M2285-anes-R5M2288-anes-R6M2460-anes-R6M1-anes-R6M2497-anes-fc_fcMatrix_mice.mat', 'FCMatrix_HbT_0p02_mice', 'FCMatrix_HbT_0p04_mice', 'FCMatrix_HbT_0p08_mice', 'FCMatrix_HbT_0p16_mice', 'FCMatrix_HbT_0p32_mice', 'FCMatrix_HbT_0p64_mice', 'FCMatrix_HbT_1p28_mice')
SpatialCorrelation_HbT_anes = nan(7);
...
save('L:\RGECO\cat\spatialCorrelation.mat','SpatialCorrelation_HbT_anes_GSR','SpatialCorrelation_HbT_awake_GSR','SpatialCorrelation_HbT_awake_anes_GSR','-append')