...
for excelRow = excelRows
    ...
    fft_pieces_total_mouse = [];
       ...
       processedName_mouse = strcat(recDate,'-',mouseName,'-',sessionType,'-datahb','.mat');
    for n = runs
        ...
        save(fullfile(saveDir,processedName),'fft_pieces_oxy','fft_pieces_deoxy','fft_pieces_total','-append')
