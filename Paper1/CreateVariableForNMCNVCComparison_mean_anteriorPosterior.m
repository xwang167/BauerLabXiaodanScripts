...
subplot(321)
for ii = 1:44
scatter(T_MRF_mice_awake_exclude_mean(ii),T_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
hold on
end
...
xlabel('NVC T(s)')
for ii = 1:44
scatter(T_MRF_mice_anes_exclude_mean(ii),T_HRF_mice_anes_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
hold on
end
...
subplot(323)
for ii = 1:44
scatter(W_MRF_mice_awake_exclude_mean(ii),W_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
hold on
end
...
subplot(324)
for ii = 1:44
scatter(W_MRF_mice_anes_exclude_mean(ii),W_HRF_mice_anes_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
hold on
end
...
subplot(325)
for ii = 1:44
scatter(A_MRF_mice_awake_exclude_mean(ii),A_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
hold on
end
...
subplot(326)
for ii = 1:44
scatter(A_MRF_mice_anes_exclude_mean(ii),A_HRF_mice_anes_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
hold on
end
