...
%     scatter(corr_Calcium_ISA(ii),T_HRF_mice_anes_exclude_mean(ii)-T_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% 
...
%     scatter(corr_HbT_ISA(ii),T_HRF_mice_anes_exclude_mean(ii)-T_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),W_HRF_mice_anes_exclude_mean(ii)-W_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     scatter(corr_HbT_ISA(ii),W_HRF_mice_anes_exclude_mean(ii)-W_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),A_HRF_mice_anes_exclude_mean(ii)-A_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     scatter(corr_HbT_ISA(ii),A_HRF_mice_anes_exclude_mean(ii)-A_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),T_MRF_mice_anes_exclude_mean(ii)-T_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% 
...
%     scatter(corr_FAD_ISA(ii),T_MRF_mice_anes_exclude_mean(ii)-T_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),W_MRF_mice_anes_exclude_mean(ii)-W_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_FAD_ISA(ii))
%     scatter(corr_FAD_ISA(ii),W_MRF_mice_anes_exclude_mean(ii)-W_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),A_MRF_mice_anes_exclude_mean(ii)-A_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
...
% for ii = 1:44
%     if ~isnan(corr_FAD_ISA(ii))
%     scatter(corr_FAD_ISA(ii),A_MRF_mice_anes_exclude_mean(ii)-A_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",raw(colorOrder(ii)*scale,:),"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
