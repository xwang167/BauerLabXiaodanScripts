function   [goodBlocks,ROI] = QC_stim_WT(oxy,deoxy,greenFluor,greenFluorCorr,green,jrgeco1a,jrgeco1aCorr,red,xform_isbrain,numBlock,numDesample,stimStartTime,stimduration,stimFreq,framerate,stimblocksize,stimbaseline,texttitle,output,input_ROI)
...
if ~isempty(goodBlocks)
    ...
    if ~isempty(jrgeco1a)
        ...
        if temp_jrgeco1a_max == 0
            temp_jrgeco1a_max = 0.001;
        end
