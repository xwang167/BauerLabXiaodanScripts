...
xlabel('Time(s)')
grid on
title(strcat('For awake:  ',num2str(qualifiedNum_NoGSR_anes),'/',num2str(totalNum_NoGSR_anes),' has r>0.6, Median: T=',num2str(locs_anes,'%4.2f'),'s, W=',num2str(w_anes,'%4.2f'),'s, A=',num2str(pks_anes,'%4.2f')))
