function [T,W,A,r,r2,hemoPred] = interSpeciesGammaFit_CalciumHbT_Mask_NoNorm_zscore(neural,hemo,t,mask)
...
options=optimset('Display','iter','MaxFunEvals',5000,'MaxIter',1,'Tol',1e-8,'TolF',1e-8);
