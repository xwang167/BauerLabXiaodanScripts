function [T,W,A,r,r2,hemoPred] = interSpeciesGammaFit_CalciumHbT_Mask_fminonc(neural,hemo,t,mask)
...
%             options.TolFun = worstErr*0.01;
            ...
            %[x,pixHrfParam,objective_val,exitflag,outputs] = evalc('fminsearchbnd(fcn,[1,1.5,0.25],[0.01,0.3,0.05],[2,3,1],options)');
             [~,pixHrfParam] = evalc('fminonc(fcn,[0.62,1.8,0.12],options)');%before 220319
