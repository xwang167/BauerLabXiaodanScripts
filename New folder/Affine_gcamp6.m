function [rawdata2 W WL2 isbrain2]=Affine_gcamp6(date,rawdata, WL, isbrain, path, seeds)%, input)%, meth)
...
MLam=seeds_init.tent;        %original clicked lambda
MMAS=seeds_init.OF;          %original clicked anterior suture
%MBreg=I.bregma;
