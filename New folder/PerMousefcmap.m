...
excelfiles=[41:50,53:73];  % Rows from Excel Database
...
deoxy=squeeze(deoxy);
gcamp3c=mean(gcampCat,4);
gcamp3c=squeeze(gcamp3c);
...
% gcamp3c=real(reshape(gcamp3c,128,128,[]));
%  
...
R_Data=cat(4, Rs_Oxy, Rs_DeOxy, Rs_GCAMP3c, Rs_GCAMP3c);%, R_FAD, R_FADc);
