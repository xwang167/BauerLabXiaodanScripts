function [T,W,A,r,r2,hemoPred,objective_vals] = GammaFit_jp_xw(neural,hemo,t,mask)
...
%options=optimset('Display','iter','MaxFunEvals',1000,'MaxIter',1000,'TolX',1e-6,'TolF',1e-6);
options=optimset('Display','iter','MaxFunEvals',500,'MaxIter',200,'TolX',1e-4,'TolF',1e-4);
...
%             options.TolFun = worstErr*0.01;
            ...
            fcn = @(param)he.fcn(param);
             ...
             [x,pixHrfParam,objective_val,exitflag,outputs] = evalc('fminsearchbnd(fcn,[0.7,1.2,0.2],[0.01,0.02,0.01],[2,3,2],options)'); %T, W, A -- guess, lower bound, upper bound
