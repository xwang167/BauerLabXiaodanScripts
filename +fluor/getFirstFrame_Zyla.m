function firstFrame = getFirstFrame_Zyla(rawdatafolder,nVx,nVy,numDarkFrames)
...
n = floor(numDarkFrames/imperfile);

jj = mod(numDarkFrames,imperfile);
...
if m > imperfile-1
    ...
    fid=fopen(fullfile(rawdatafolder, tempdir2(n+1).name));
...
firstFrame =BinBySum(tempdata, nVy, nVx);
