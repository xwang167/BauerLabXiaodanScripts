...
for ii = 0:1
    ...
    %
    %             if isDetrend
    %                 raw_detrend = preprocess.detrend(rawdata,sessionInfo.detrendTemporally,sessionInfo.detrendSpatially);
    %
    %                 % smooth image
        ...
        for n = runs
            ...
            elseif strcmp(sessionType,'stim')
                ...
                if isGSR
                    ...
                    xform_datahb_GSR = mouse.preprocess.gsr(xform_datahb,xform_isbrain);
                    ...
                    if strcmp(char(sessionInfo.mouseType),'gcamp6f')
                        ...
                        xform_gcamp_GSR = mouse.preprocess.gsr(xform_gcamp,xform_isbrain);
                        xform_gcampCorr_GSR = mouse.preprocess.gsr(xform_gcampCorr,xform_isbrain);
                        xform_green_GSR = mouse.preprocess.gsr(xform_green,xform_isbrain);
