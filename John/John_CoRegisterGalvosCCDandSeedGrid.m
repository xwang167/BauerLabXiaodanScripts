function [GoodSeedsidx, GalvoSeedCenter,GalvoSeedCenterCCDSpace,OF,T,isbrain]=John_CoRegisterGalvosCCDandSeedGrid(FileName)
...
CorrectedGoodSeeds = John_GalvoSeedCurvatureCxn(GoodSeeds(:,1:2),I,30,5);
GoodSeeds(:,1:2) = CorrectedGoodSeeds;
