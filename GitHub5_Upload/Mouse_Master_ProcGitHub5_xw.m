...
oldpath=path;
addpath(genpath('C:\Users\xiaodanwang\Documents\GitHub\BauerLabXiaodanScripts\GitHub5_Upload'));

database='L:\RGECO\RGECO_Eric.xlsx'; %EDIT name of excel sheet with mice
excelrows=[3:8]; %EDIT lines corresponding to mice to process from excel sheet
...
path(oldpath); %reset the path back to original
