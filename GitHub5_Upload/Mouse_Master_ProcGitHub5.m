...
oldpath=path;
addpath(genpath('C:\MatlabScripts\GitHub5_Upload'));

database='C:\MatlabScripts\Landsness\GitHub5DataSheet.xlsx'; %EDIT name of excel sheet with mice
excelrows=[34:46]; %EDIT lines corresponding to mice to process from excel sheet
