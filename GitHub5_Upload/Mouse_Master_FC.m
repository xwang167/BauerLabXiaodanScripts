...
database='LindseyZIKADataSheet.xlsx'; %EDIT name of excel sheet with mice
excelrows=[4:18 27:44]; %EDIT lines corresponding to mice to process from excel sheet
