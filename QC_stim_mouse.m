...
excelRows = [182,184,186,237];%182,184,186,203,
...
for excelRow = excelRows
    ...
    for n = 1:3
        ...
        %         clear xform_datahb
        %
        %              xform_datahb_baseline = mean(xform_datahb_NoGSR(:,:,:,1:5*sessionInfo.framerate,:),4);
        ...
        %xform_datahb_GSR = reshape(xform_datahb_GSR,128,128,2,[],numBlocks);
        % xform_datahb_GSR_baseline = mean(xform_datahb_GSR(:,:,:,1:5*sessionInfo.framerate,:),4);
