...
excelFile = "D:\GCaMP\GCaMP_awake.xls";
 stimStartTime = 5;
...
clear xform_green_GSR
    ...
    if strcmp(char(sessionInfo.mouseType),'gcamp6f')
        xform_gcamp_mouse_NoGSR = mean(xform_gcamp_mouse_GSR,4);
...
clear xofrm_datahb_mouse_NoGSR xform_jrgeco1a_mouse_NoGSR xform_jrgeco1aCorr_mouse_NoGSR xform_red_mouse_NoGSR  xform_FAD_mouse_NoGSR xform_FADCorr_mouse_NoGSR xform_green_mouse_NoGSR    
