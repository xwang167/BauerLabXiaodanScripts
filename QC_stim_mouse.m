...
%             xform_datahb_GSR = reshape(xform_datahb_GSR,128,128,2,[],numBlocks);
            ...
            elseif strcmp(sessionInfo.mouseType,'jrgeco1a-opto3')
                load(fullfile(saveDir, processedName),'xform_jrgeco1a_GSR','xform_jrgeco1aCorr_GSR','xform_red_GSR','xform_Laser','ROI_NoGSR','goodBlocks_GSR')
                goodBlocks_GSR = 1:10;
...
%         clear xofrm_datahb_mouse_GSR
    elseif strcmp(char(sessionInfo.mouseType),'jrgeco1a-opto3')
        ...
        save(fullfile(saveDir,processedName_mouse),'xform_jrgeco1a_mouse_NoGSR','xform_jrgeco1aCorr_mouse_NoGSR','xform_red_mouse_NoGSR','ROI_NoGSR','-append')
        texttitle_NoGSR = strcat(mouseName,'-stim'," ",'without GSR nor filtering');
