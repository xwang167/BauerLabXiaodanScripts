...
for excelRow = excelRows
    ...
    for n = runs
       ...
       FAD_filter = reshape(FAD_filter,128,128,[]);
       tic
       [T_CalciumFAD,W_CalciumFAD,A_CalciumFAD,r_CalciumFAD,r2_CalciumFAD,FADPred_CalciumFAD] = interSpeciesGammaFit_CalciumFAD_noMask(Calcium_filter,FAD_filter,t);
       toc
...
%     save(fullfile(saveDir,processedName_mouse),'T_CalciumFAD_mouse','W_CalciumFAD_mouse','A_CalciumFAD_mouse','r_CalciumFAD_mouse','r2_CalciumFAD_mouse','-append')
%     
%     figure
%     subplot(2,3,1)
