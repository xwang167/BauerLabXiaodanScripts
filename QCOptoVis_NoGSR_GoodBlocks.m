...
for excelRow = excelRows
    ...
    texttitle = strcat(mouseName,'-stim'," ",'without GSR nor filtering');
    output= fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim','-NoGSR'));
    ...
    close all
        save(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'ROI_GSR','xform_datahb_mouse','xform_jrgeco1aCorr_mouse','xform_jrgeco1a_mouse','xform_red_mouse',...
...
for excelRow = excelRows
    ...
    processedName_mouse = strcat(recDate,'-',mouseName,'-',sessionType,'_processed_mouse','.mat');
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_jrgeco1aCorr_mouse')
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_jrgeco1a_mouse')
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_red_mouse')
    ...
    load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'xform_datahb_mouse')
    ...
    clear xform_datahb_mouse
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'oxy_downsampled_mouse')
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'deoxy_downsampled_mouse')
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'jrgeco1a_downsampled_mouse')
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'jrgeco1aCorr_downsampled_mouse')
        ...
        load(fullfile(saveDir,strcat(recDate,'-',mouseName,'-stim.mat')),'red_downsampled_mouse')
...
load(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'ROI','peakMap_ROI_mice')
...
save(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'peakMap_ROI_mice','xform_datahb_mice','xform_jrgeco1aCorr_mice','xform_jrgeco1a_mice','xform_red_mice',...
...
if strcmp(sessionInfo.mouseType,'jrgeco1a-opto3')
       load(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'goodBlocksNum')
    texttitle = strcat(miceName,'-stim'," ",num2str(goodBlocksNum),"blocks ",'without GSR nor filtering');
    output= fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim','-NoGSR'));
...
load(fullfile(saveDir_cat,strcat(recDate,'-',miceName,'-stim.mat')),'peakMap_ROI_mice','xform_datahb_mice','xform_jrgeco1aCorr_mice','xform_jrgeco1a_mice','xform_red_mice',...
