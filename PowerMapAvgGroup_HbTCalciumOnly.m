...
%         
            ...
            save(strcat(save_name,'.mat'),'tmp_powerMap', 'whole_spectra_map_group_avg' , 'power_map_group_avg', 'global_sig_for_group_avg',...
...
%PLOTTING     
    %% Non-overlay contrast
        ...
        lims={[-120 -105],[-120 -105],[-130 -120]; ...
              ...
              [-50 -35],  [-50 -40],  [-60 -50]}; %Manually determined ranges for contrast and band
        ...
        for i=3:4
            ...
            if i<=3 
                cb.Label.String='10*log_1_0(\DeltaM^2)'; 
            else
            ...
            savefig(fh,strcat(save_name,'-MAP-HbTCalcium.fig'));
            saveas(fh,strcat(save_name,'-MAP-HbTCalcium.png')); 
    end
end