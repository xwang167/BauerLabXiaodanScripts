...
adist=norm(L.of-L.lambda);    %Paxinos Space
idist=norm(OF-T);           %Mouse Space

aa=atan2(L.of(1)-L.lambda(1),L.of(2)-L.lambda(2));  %Angle in Paxinos Space
...
affineMarkers.lambda=pixmm*(L.lambda*R);
affineMarkers.OF=pixmm*(L.of*R);

t=T-affineMarkers.lambda;             %translation=mouse-Paxinos

affineMarkers.bregma=affineMarkers.bregma+t;
affineMarkers.lambda=affineMarkers.lambda+t;
