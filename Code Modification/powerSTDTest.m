...
er = errorbar(1:3,[power_jrgeco1aCorr_ISA_ratio_mean, power_FADCorr_ISA_ratio_mean, power_total_ISA_ratio_mean],...
    [power_jrgeco1aCorr_ISA_ratio_std, power_FADCorr_ISA_ratio_std, power_total_ISA_ratio_std]);
er.Color = [0 0 0];                            
er.LineStyle = 'none';  
...
er = errorbar(1:3,[power_jrgeco1aCorr_Delta_ratio_mean, power_FADCorr_Delta_ratio_mean, power_total_Delta_ratio_mean],...
    [power_jrgeco1aCorr_Delta_ratio_std, power_FADCorr_Delta_ratio_std, power_total_Delta_ratio_std]);
er.Color = [0 0 0];                            
er.LineStyle = 'none';  
