function [rawFig, displacement] = qcRaw(runInfo,time,raw,representativeCh,isbrain,droppedFrames,system)
...
if isempty(droppedFrames)
    ...
    saveLoc = [runInfo.saveFolder filesep runInfo.recDate '-' runInfo.mouseName '-'...
    runInfo.session '' num2str(runInfo.run) '-rawQCData_dropCorr.mat'];
end
