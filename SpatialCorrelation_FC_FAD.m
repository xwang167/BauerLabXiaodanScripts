...
load('191030--R5M2285-R5M2286-R5M2288-R6M2460-awake-R6M1-awake-R6M2497-awake-fc_fcMatrix_mice_noGSR.mat',...
    'FCMatrix_FAD_0p01_mice','FCMatrix_FAD_0p02_mice', 'FCMatrix_FAD_0p04_mice', 'FCMatrix_FAD_0p08_mice', ...
    'FCMatrix_FAD_0p16_mice', 'FCMatrix_FAD_0p32_mice', 'FCMatrix_FAD_0p64_mice', 'FCMatrix_FAD_1p28_mice')
FCMatrix_FAD_0p01_mice_awake =FCMatrix_FAD_0p01_mice;
...
SpatialCorrelation_FAD_awake = nan(8);
...
'FCMatrix_FAD_0p01_mice','FCMatrix_FAD_0p02_mice', 'FCMatrix_FAD_0p04_mice', 'FCMatrix_FAD_0p08_mice',...
    'FCMatrix_FAD_0p16_mice', 'FCMatrix_FAD_0p32_mice', 'FCMatrix_FAD_0p64_mice', 'FCMatrix_FAD_1p28_mice')
SpatialCorrelation_FAD_anes = nan(8);
...
SpatialCorrelation_FAD_awake_anes = nan(8);
for ii = 1:8
    for jj = 1:8
...
save('L:\RGECO\cat\spatialCorrelation_0p01.mat','SpatialCorrelation_FAD_anes','SpatialCorrelation_FAD_awake','SpatialCorrelation_FAD_awake_anes','-append')
...
SpatialCorrelation_FAD_anes_GSR = nan(8);
...
save('L:\RGECO\cat\spatialCorrelation_0p01.mat','SpatialCorrelation_FAD_anes_GSR','SpatialCorrelation_FAD_awake_GSR','SpatialCorrelation_FAD_awake_anes_GSR','-append')