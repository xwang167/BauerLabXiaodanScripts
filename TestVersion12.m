...
data_full_gsr= resample(data_full_gsr,(2*fRange_delta(2)*1.25),25,'Dimension',3 ); %resample to 10 Hz
data_full = resample(data_full,(2*fRange_delta(2)*1.25),25,'Dimension',3 ); %resample to 10 Hz
