...
excelRows = [181 183 185 228 232 236 202 195 204 230 234 240]; %excelRows_anes = [ 202 195 204 230 234 240];
...
mask = mask_new.*xform_isbrain;
    for n = runs
       ...
       saveName =  strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_nan.mat');
        save(fullfile(saveDir,saveName),'T_CalciumFAD','W_CalciumFAD','A_CalciumFAD','r_CalciumFAD','r2_CalciumFAD','FADPred_CalciumFAD','-v7.3')
