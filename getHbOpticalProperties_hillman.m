function [op, E] = getHbOpticalProperties_hillman(muspFcn,lightSourceFiles, varargin)
...
[lambda1, extCoeff] = bauerParams.getExtCoeff(extCoeffFile); % Get hemoglobin extinction coefficients
% extCoeff is 1/(cm*M)
...
%%%
hillmanFile = 'C:\Users\xiaodanwang\Documents\GitHub\BauerLabXiaodanScripts\pathlengths_hillman.txt';
fid=fopen(hillmanFile);
