...
save('L:\RGECO\cat\crossLag_allRegions.mat','crossLagX_NVC','crossLagY_NVC_awake_mice','crossLagY_NVC_anes_mice','crossLagY_NMC_awake_mice','crossLagY_NMC_anes_mice')
%% Visualization
load("GoodWL.mat")
