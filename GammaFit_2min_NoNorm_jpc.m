    ...
    for n = runs
        ...
        for ii = 1:5
            ...
            [T_CalciumHbT_2min_NoNorm(:,:,ii),W_CalciumHbT_2min_NoNorm(:,:,ii),A_CalciumHbT_2min_NoNorm(:,:,ii),...
                ...
                = GammaFit(Calcium_filter(:,:,(ii-1)*120*5+1:ii*120*5)*100,...
        ...
        if exist(fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_2min_NoNorm_jpc','.mat')),'file')
            save(fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_2min_NoNorm_jpc','.mat')),...
        ...
        title('A')
        set(gca,'FontSize',14,'FontWeight','Bold')
        sgtitle(strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'-CalciumHbT-GammaFit-2min-NoNorm_jpc'))
        
        saveas(gcf,fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_CalciumHbT_GammaFit_2min_NoNorm_jpc.png')));
        saveas(gcf,fullfile(saveDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_CalciumHbT_GammaFit_2min_NoNorm_jpc.fig')));  
    end
end
